        ...
        <div className="grid-container">
            <div className="login-card">
                ...
                <form className="login-form" action="">
                    ...
                    <div className="check-div"><input type="checkbox" className="form-check" /> Keep me signed in</div>
                    <Link to='/home'><button type="submit" className="form-input btn">Sign In</button></Link>
                </form>
